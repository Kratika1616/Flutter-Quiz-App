...
import 'package:quiz_app/screens/quiz/java_quiz_screen.dart';
...
class Jlevel extends StatefulWidget {
  @override
  _JlevelState createState() => _JlevelState();
}

class _JlevelState extends State<Jlevel> {
  @override
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => JavaQuizScreen()));
                    },
                  ),
                ),
                SizedBox(
